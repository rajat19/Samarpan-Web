	...
	<div class="container">
		...
		<div class="row" id="accordion">
			<div class="col-md-5 col-md-offset-1 col-sm-12 clearfix hidden-xs hidden-sm" style="text-align:center;padding-top:120px;" id="hidediv">
				...
				<a style="color:white;border-color:white;" class="btn btn-danger-outline">Senior Citizen in Nation Building...</a>
			</div>
	...
	<div class="container">
	   	{{--  --}}
			...
			<div class="col-md-12 col-sm-12">
				<h1>Senior Citizen in Nation Building...</h1><br>
				<!-- <h4>because</h4> -->
				<!-- <a class="btn btn-danger-outline">Senior Citizen in Nation Building...</a> -->
			</div>
		</div>
	   	{{--  --}}
	</div>		
